  ...
  return (
    ...
    >
      ...
      <p className="mt-6 text-xl leading-8 text-gray-500">
        Harriet Tubman conseguiu fugir graças a Underground Railroad, uma rede
        secreta que ajudava escravos a fugir e conquistar a liberdade no norte
        dos Estados Unidos. Essa rede levava os escravos para estados onde a
        escravidão era proibida ou então os guiava até o Canadá, país que não
